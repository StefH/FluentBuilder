...
namespace FluentBuilderGeneratorTests.DTO
{
    public partial class UserTWithAddressAndConstructorBuilder<T> : Builder<UserTWithAddressAndConstructor<T>> where T : struct
    {
        ...
        public UserTWithAddressAndConstructorBuilder<T> WithAddress(Action<AddressBuilder<Int16>> action, bool useObjectInitializer = true) => WithAddress(() =>
        {
            var builder = new AddressBuilder<Int16>();
            action(builder);
