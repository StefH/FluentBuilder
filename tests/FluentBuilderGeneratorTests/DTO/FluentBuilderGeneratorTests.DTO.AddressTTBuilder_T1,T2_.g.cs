...
{
    public partial class AddressTTBuilder<T1,T2> : Builder<AddressTT<T1, T2>> where T1 : struct where T2 : class, new()
    {
        ...
        public override AddressTT<T1, T2> Build(bool useObjectInitializer = true)
        {
            if (Object?.IsValueCreated != true)
            {
                Object = new Lazy<AddressTT<T1, T2>>(() =>
                {
                    ...
                    var instance = new AddressTT<T1, T2>();
