        ...
        public override Address Build(bool useObjectInitializer)
        {
            if (Instance?.IsValueCreated != true)
            {
                Instance = new Lazy<Address>(() =>
                {
                    ...
                    if (_thingUsingConstructorWithItselfIsSet) { instance.ThingUsingConstructorWithItself = _thingUsingConstructorWithItself.Value; }
                    if (_thingUsingConstructorWith2ParametersIsSet) { instance.ThingUsingConstructorWith2Parameters = _thingUsingConstructorWith2Parameters.Value; }
