...
namespace AbcTest.OtherNamespace
{
    public partial class IListClassOnOtherNamespaceBuilder : Builder<IList<AbcTest.OtherNamespace.ClassOnOtherNamespace>>
    {
        ...
        public IListClassOnOtherNamespaceBuilder Add(Action<ClassOnOtherNamespaceBuilder> action, bool useObjectInitializer = true)
        {
            var builder = new ClassOnOtherNamespaceBuilder();
            action(builder);
