...
namespace FluentBuilderGeneratorTests.Issue60
{
    ...
    public partial class MyEntityBuilder : Builder<FluentBuilderGeneratorTests.Issue60.MyEntity>
    {
        ...
        private Lazy<AzureETag123> _eTag = new Lazy<AzureETag123>(() => default(AzureETag123));
        public MyEntityBuilder WithETag(AzureETag123 value) => WithETag(() => value);
        public MyEntityBuilder WithETag(Func<AzureETag123> func)
        {
            _eTag = new Lazy<AzureETag123>(func);
            _eTagIsSet = true;
            return this;
        }
        private bool _testIsSet;
        private Lazy<string> _test = new Lazy<string>(() => string.Empty);
        public MyEntityBuilder WithTest(string value) => WithTest(() => value);
        public MyEntityBuilder WithTest(Func<string> func)
        {
        ...
        public override MyEntity Build(bool useObjectInitializer)
        {
            ...
            if (_testIsSet) { Instance.Value.Test = _test.Value; }
